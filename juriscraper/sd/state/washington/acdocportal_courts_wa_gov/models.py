...
class WaDocketEntry(ScrapedData):
    ...
    doc_filed_date: date | None = None
    """Date the document was filed or issued (from the "Doc Filed Date" column)."""
...
class WaDownloadedDocument(ScrapedData):
    ...
    ``(court_id, docket_id, document_id)``.
    """
...
class WaDocket(ScrapedData):
    ...
    case number by the ACDocPortal KeywordSearch API.
    """
