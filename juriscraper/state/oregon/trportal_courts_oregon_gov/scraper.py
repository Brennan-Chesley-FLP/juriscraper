...
Dockets Flow (dockets_by_filing_date):
  ...
  7. parse_documents_list -> queues per-document archive downloads, yields OreDocket
  8. parse_document_download -> emits an OreDocument per archived file
...
class OregonScraper(
    ...
    # Oregon populates the per-case ticklers (deadlines) endpoint.
