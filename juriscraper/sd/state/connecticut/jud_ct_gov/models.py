...
- connsuperct: Connecticut Superior Court (trial court)
"""
...
class ConnOpinionCluster(ScrapedData):
...
class ConnOralArgument(ScrapedData):
...
class ConnDocketEntry(ScrapedData):
...
class ConnDocketUnavailable(ScrapedData):
