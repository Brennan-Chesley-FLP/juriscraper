...
class TestBothHooksTogether:
    ...
    def test_hooks_work_with_multiple_runs(
        self, server_url: str, tmp_path: Path
    ) -> None:
        ...
        # Track calls across runs
        start_count = {"count": 0}
        complete_count = {"count": 0}
        ...
        # Each hook should have been called 3 times
        assert start_count["count"] == 3
        assert complete_count["count"] == 3
