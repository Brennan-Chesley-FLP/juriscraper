...
Dockets Flow (get_dockets / get_dockets_by_date):
  ...
  5. parse_docket_entries -> parses entries, yields final WyoDocket
...
class WyomingScraper(
    ...
    Usage:
        ...
        params.WyoOralArgument = None
        scraper = WyomingScraper(params=params)

        # Filter dockets by date range
        params = WyomingScraper.params()
        params.WyoDocket.date_filed.gte = date(2025, 1, 1)
        params.WyoDocket.date_filed.lte = date(2025, 12, 31)
        scraper = WyomingScraper(params=params)
    """
    ...
    def get_dockets(self) -> Generator[Request, None, None]:
        ...
        """
        date_gte, date_lte, _, _ = self._tr_get_search_params("WyoDocket")
    ...
    def get_oral_arguments(self) -> Generator[Request, None, None]:
        ...
        date_gte, date_lte, _, _ = self._tr_get_search_params(
            "WyoOralArgument", date_field_name="date_argued"
        )
